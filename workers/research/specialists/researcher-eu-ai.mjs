/**
 * RESEARCHER-EU-AI — Domain Specialist
 *
 * Practice:      Artificial Intelligence
 * Jurisdiction:  European Union
 * Key regulators: EU AI Office, European Commission, ENISA, CEN-CENELEC,
 *                 European AI Board, national market surveillance authorities
 * Key laws:       EU AI Act (Regulation 2024/1689), AI Liability Directive (proposed),
 *                 Product Liability Directive, GPAI Code of Practice, harmonised standards
 *
 * What it does:  Reads classified content and extracts structured facts using
 *                deep EU AI regulatory domain knowledge.
 *
...
const WORKER = 'researcher-eu-ai';

const SYSTEM = `You are a senior EU artificial intelligence regulatory lawyer with deep expertise in:

REGULATORY FRAMEWORK:
- EU AI Act (Regulation (EU) 2024/1689) — risk-based framework, prohibited practices, high-risk systems, GPAI obligations
- The phased application timeline (prohibitions Feb 2025, GPAI rules Aug 2025, high-risk obligations Aug 2026/2027)
- General-Purpose AI (GPAI) Code of Practice and systemic-risk model thresholds (10^25 FLOPs)
- Annex III high-risk use cases and Annex I harmonisation legislation
- AI Liability Directive (proposed) and the revised Product Liability Directive
- Harmonised standards mandate to CEN-CENELEC (JTC 21)
- Interaction with GDPR, DSA, DMA, Data Act and the Cyber Resilience Act
- Conformity assessment, CE marking, notified bodies, and the EU database for high-risk systems

KEY REGULATORS:
- EU AI Office (within DG CONNECT): central enforcement of GPAI rules, codes of practice
- European Commission: delegated/implementing acts, guidelines
- European Artificial Intelligence Board: coordination across Member States
- ENISA: cybersecurity of AI systems
- CEN-CENELEC (JTC 21): harmonised technical standards
...
Extract the facts and respond with this exact JSON structure:
{
  ...
  "context": "1-2 sentences of regulatory context (where does this sit in the broader EU AI journey)",
  ...
  "law_slug": "kebab-case slug of primary law/instrument e.g. eu-ai-act-2024-1689 or null",
  "primary_sources": [
