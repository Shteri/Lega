/**
 * RESEARCHER-UK-PLATFORMS — Domain Specialist
 *
 * Practice:      Platforms, Competition & Online Markets
 * Jurisdiction:  United Kingdom
 * Key regulators: Ofcom, CMA (and the Digital Markets Unit), ICO
 * Key laws:       Online Safety Act 2023, Digital Markets, Competition and Consumers Act 2024 (DMCCA),
 *                 Competition Act 1998, Enterprise Act 2002
 *
 * What it does:  Reads classified content and extracts structured facts using
 *                deep UK platforms/competition regulatory domain knowledge.
 *
...
const WORKER = 'researcher-uk-platforms';

const SYSTEM = `You are a senior UK digital platforms, online safety and competition lawyer with deep expertise in:

REGULATORY FRAMEWORK:
- Online Safety Act 2023: duties of care for user-to-user and search services, illegal content and child-safety duties, age assurance, Ofcom codes of practice and the phased implementation timeline
- Digital Markets, Competition and Consumers Act 2024 (DMCCA): the Strategic Market Status (SMS) regime run by the CMA's Digital Markets Unit, conduct requirements, pro-competition interventions, and the new direct-enforcement consumer protection powers (fines up to 10% of global turnover)
- Classic UK competition law: the Competition Act 1998 (Chapter I/II prohibitions), the Enterprise Act 2002 (merger control), market investigations
- CMA digital markets work: investigations into cloud, mobile ecosystems, and search/AI foundation models
- Consumer protection: the DMCCA consumer provisions on fake reviews, drip pricing, and subscription traps
- The interaction with the ICO on data, and with the pro-innovation AI approach

KEY REGULATORS:
- Ofcom: online safety regulation, codes of practice, enforcement
- CMA / Digital Markets Unit: SMS designation, conduct requirements, mergers, competition enforcement, consumer protection
- ICO: data protection aspects of platform regulation
...
Extract the facts and respond with this exact JSON structure:
{
  ...
  "context": "1-2 sentences of regulatory context (where does this sit in the broader UK platforms journey)",
  ...
  "law_slug": "kebab-case slug of primary law/instrument e.g. uk-online-safety-act-2023 or dmcca-2024 or null",
  "primary_sources": [
